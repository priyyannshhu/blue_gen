  ...
  return (
    <footer className="text-center h-16 sm:h-20 w-full sm:pt-2 pt-4 border-t mt-5 flex flex-col justify-between items-center px-3 space-y-3 sm:mb-0 mb-3">
      ...
      <div className="flex space-x-4 pb-4 sm:pb-0">
        <Link
          href="https://x.com/priyanshu_37?t=lWDhWGU9HCdXh-TtcYRe9A&s=09"
          className="group"
          aria-label="BlueGen on Twitter"
        >
          <svg
            aria-hidden="true"
        ...
        <Link
          href="https://github.com/priyyannshhu/BlueGen"
          className="group"
          aria-label="BlueGen on GitHub"
        >
          <svg
            aria-hidden="true"
            className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700"
        ...
        <Link
          href="https://www.facebook.com/profile.php?id=100071470032232"
          className="group"
          aria-label="BlueGen on Facebook"
        >
          <svg
            aria-hidden="true"
            className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700"
